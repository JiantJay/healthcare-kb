...
├── sources/           # 소스 노트 (1소스 = 1파일, YYYY-MM-DD_주제.md)
...
5. **새 소스 추가**: `templates/source_template.md` 포맷 준수 — ① 메타데이터 ② 핵심 요약(두괄식) ③ 주제별 정리 ④ 전체 자막(타임스탬프). 파일명은 `sources/YYYY-MM-DD_핵심주제.md`.
...
- 사실·수치 근거는 `refs/healthcare-kb/sources/<파일>.md`를 출처로 명기.
